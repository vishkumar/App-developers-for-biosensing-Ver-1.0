...
extern NSString *  randomText;
extern NSString * UUID_KEY;
//extern NSString *tempValuestr;
...
#define SENSORTAG_SERVICE_UUID @"180D"
...
#define UUID_IRT_CONF @"2A1D" // 0: disable, 1: enable
...
@property (nonatomic, strong) NSString *tempvaluestr;
